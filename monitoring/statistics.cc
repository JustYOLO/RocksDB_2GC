...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    {FLUSH_KEY_DROP_NEWER_ENTRY, "rocksdb.flush.key.drop.new"},
    {FLUSH_KEY_DROP_OBSOLETE, "rocksdb.flush.key.drop.obsolete"},
    {MEMTABLE_FLUSH_COUNT, "rocksdb.memtable.flush.count"},
    {MEMTABLE_HIT_TIME_NANOS, "rocksdb.memtable.hit.time.nanos"},
    {BLOCK_CACHE_HIT_TIME_NANOS, "rocksdb.block.cache.hit.time.nanos"},
    {DISK_HIT_TIME_NANOS, "rocksdb.disk.hit.time.nanos"},
    {BLOCK_CACHE_KEY_HIT, "rocksdb.block.cache.key.hit"},
    ...
    {GET_HIT_L6_AND_UP, "rocksdb.l6andup.hit"},
...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {FLUSH_MEM_ITERATOR_SETUP_MICROS,
     "rocksdb.flush.mem.iterator.setup.micros"},
    {FLUSH_READ_MERGE_MICROS, "rocksdb.flush.read.merge.micros"},
    {FLUSH_WRITE_BLOCK_MICROS, "rocksdb.flush.write.block.micros"},
    {FLUSH_FINISH_MICROS, "rocksdb.flush.finish.micros"},
    {FLUSH_INSTALL_MICROS, "rocksdb.flush.install.micros"},
    {FLUSH_HOT_KEY_DETECT_MICROS, "rocksdb.flush.hot.key.detect.micros"},
};
